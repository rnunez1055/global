...
function initSEO(&$seo) {
	if (!$seo ->metaTitle || (!$seo ->metaDescription || !$seo ->metaKeyword) ) {
		$seo ->metaTitle = !$seo ->metaTitle ? "American School" : $seo ->metaTitle;
		$seo ->metaDescription = !$seo ->metaDescription ? "American School" : $seo ->metaDescription;
		$seo ->metaKeyword = !$seo ->metaKeyword ? "American School" : $seo ->metaKeyword;
	}
}
?>