...
$_SESSION["m1"]="content";
$_SESSION["m2"]="servicios-list";
$objName="Page"; $objUrl="servicios"; $objTitle="Servicios";
...
if (isset($_POST['submit'])) {
	...
	$objLoad ->category ->id = ID_SUBCAT_SERVICIOS;
...
$(document).ready(function(){
    ...
    <?php include("sidebar.php"); ?>
      ...
      <div id="list">
        ...
        <div id="content-tabs">
          <ul>
            <li><a href="#fragment-1" ><span>Servicio</span></a></li>
...
<?php $objLoad ->pFile('banner_movil3', "{$_SERVER['PHP_SELF']}?id={$objLoad ->id}&action=delbanner_movil3", 'banner_movil3', 'img', false) ?></td>
            ...
            <div id="fragment-2">
              <fieldset>
                <legend> Informaci&oacute;n Inglés </legend>
                <table cellpadding="0" cellspacing="0" class="table-form">
                  <tr>
                      <th>T&iacute;tulo En: </th>
                      <td><?php $objLoad ->qText('title_en', '', 'width:548px');?></td>
                  </tr>
                  <tr>
