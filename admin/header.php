...
<title>CMS</title>
<link rel="SHORTCUT ICON" href="../contenido/img/favicon.ico" />
...
<script type="text/javascript" src="<?php echo LBN_ADMIN_JAVASCRIPT; ?>plugins/jquery.uploadifive.min.js"></script>
...
<div class="span-25">
  <div id="menu-principal" style="position:relative" >
    <ul>
      ...
      <li class="<?php if ($_SESSION['m1']=='banner') { echo "current"; } else { echo "" ;}?>"><a href="banner-list.php" >Banners</a></li>
      <li class="<?php if ($_SESSION['m1']=='content') { echo "current"; } else { echo "" ;}?>"><a href="category-list.php" >P&aacute;ginas</a></li>
      <li class="<?php if ($_SESSION['m1']=='general') { echo "current"; } else { echo "" ;}?>"><a href="general.php" >DATOS GENERALES</a></li>
    </ul>
