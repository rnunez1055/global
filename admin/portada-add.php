...
include '../_common.php';	
$_SESSION["m1"]="content";
$_SESSION["m2"]="portada-list";
$objName="Page"; $objUrl="portada"; $objTitle="Portada";
...
if (isset($_POST['submit'])) {
	...
	$objLoad ->category ->id = ID_SUBCAT_PORTADA;
...
$(document).ready(function(){
    ...
    <tr>
      <th>Cuadro Verde: </th>
      <td><?php $objLoad ->qEditor('description_en', array('toolbar' => 'multimedia', 'stylesSet' => 'custom')); ?></td>
    </tr>

    <tr>
      <th>Cuadro Productos: </th>
      <td><?php $objLoad ->qEditor('description_ventasproductos', array('toolbar' => 'multimedia', 'stylesSet' => 'custom')); ?></td>
    </tr>

    <tr>
      <th>Cuadro Inferior: </th>
      <td><?php $objLoad ->qEditor('description_ultimo', array('toolbar' => 'multimedia', 'stylesSet' => 'custom')); ?></td>
    </tr>
