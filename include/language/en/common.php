...
$GLOBALS["langFront"] = array(
		"t_siguenos" => "Follow us",
		"t_go" => "Go to",
		"t_pagina_principal" => "Main Page",
		"t_buscar_aqui" => "SEARCH HERE",
		"t_ultimas_not" => "LATEST<br/>NEWS",
		"t_alianzas" => "STRATEGIC <span> ALLIANCES </ span>",
		"t_copyright" => "&copy; Copyright 2017. All Rights Reserved.",
		
		/*MAIN MENU*/
		"t_inicio" => "HOME",
		"t_nuestra_cultura" => "OUR CULTURE",
		"t_nuestros_niveles" => "OUR LEVELS",
		"t_preschool" => "PRESCHOOL",
		"t_primary" => "PRIMARY",
		"t_secondary" => "SECONDARY",
		"t_technology" => "TECHNOLOGY",
		"t_proyecto_cas" => "CAS PROJECT",
		"t_eco_sports_center" => "ECO SPORTS CENTER",
		"t_admision" => "ADMISSION",
		"t_contacto" => "CONTACT",
		
		/**/
		
		"t_atributos_alumnos" => "ATTRIBUTES FOR OUR STUDENTS",
		"t_metodologia_innovadora" => "INNOVATIVE METHODOLOGY WITH PERMANENT AND CONTINUOUS EVALUATION",
		"t_profesores_extranjeros" => "PERUVIAN AND FOREIGN PROFESSORS GRADUATED ABROAD",
		"t_aula_equipada" => "CLASSROOM EQUIPPED WITH AUDIO, MULTIMEDIA PROJECTS AIR CONDITIONING AND ERGONOMIC FURNITURE",
		"t_aula_virtual" => "VIRTUAL AND MODERN WEB PAGE",
		"t_moderno_eco" => "MODERN ECO-SPORTS CENTER",
		"t_equipo_tecnologia" => "EQUIPMENT WITH TABLETS, MIMIO PADS AND MULTIMEDIA LABORATORY TECHNOLOGY",
		
		/**/
		
		"t_perfil_estudiante" => "PROFILE OF OUR STUDENT",
		"t_dominio_idioma" => "ENGLISH LANGUAGE COMPLETE DOMAIN",
		"t_verdadero_ciudadano" => "TRUE MULTILINGUAL CITIZEN",
		"t_formar_conciencia" => "FORMING A NATIONAL AND INTERNATIONAL CONSCIOUSNESS",
		"t_desarrollar_espiritu" => "DEVELOP THE CRITICAL AND INDIGATOR SPIRIT",
		"t_dominio_tecnologia" => "PUNTA TECHNOLOGY DOMAIN",
		"t_proactividad" => "PROACTIVITY TO FORM A SOLID COMMUNITY AND TO FORCE A SUSTAINABLE SOCIETY",
		
		/**/
		
		"t_tit_admision" => "ADMISSION 2017",
		"t_mayor_informacion" => "MORE INFORMATION",
		
		/**/
		
		"t_mnu_informacion" => "INFORMATION MENU",
		"t_des_li_not" => "LIST OF NEWS",
);
